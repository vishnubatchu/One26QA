({
    ...
    serverCall : function(component, event, helper) {  
        ...
        component.set('v.searchKeyword',searchText);
          console.log(component.get("v.objectName"));
           console.log( component.get("v.field_API_search")+'val search   '+field_API_search);
        var last_SearchText = component.get("v.last_SearchText");
        console.log(last_SearchText +'last search text ');
        ...
        if (event.keyCode == 27 || !searchText.trim()) { 
            ...
            var field_API_search_marketingPN = component.get('v.field_API_search_marketingPN');
            var limit = component.get("v.limit");
            console.log( field_API_val+'val search   '+field_API_search);
            ...
            action.setParams({
                ...
                field_API_search_marketingPN:field_API_search_marketingPN,
